...
const Skills = () => {
  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <div className="flex size-full min-h-screen flex-col text-foreground">
        <div className="layout-container flex h-full grow flex-col">
          <div className="px-4 sm:px-10 md:px-20 lg:px-40 flex flex-1 justify-center py-10 sm:py-16">
