...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="relative flex size-full min-h-screen flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-2xl mx-auto animate-scale-in">
          <Card className="bg-card rounded-2xl shadow-2xl overflow-hidden border-border">
            <div className="px-6 py-8 sm:px-10 sm:py-12">
              {/* Header */}
              <div className="text-center">
                <h1 className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-hero">
                  Hablemos
                </h1>
