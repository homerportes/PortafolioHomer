...
const SkillsSection = () => {
  ...
  const skillCategories = [
    ...
    {
      title: "Frontend",
      description: "Desarrollo del lado del cliente",
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Postman", icon: <div className="w-15 h-15 bg-orange-500 rounded flex items-center justify-center text-white text-lg font-bold">P</div> }
      ],
      color: "from-purple-800 to-purple-900"
    }
  ];
      ...
      <div className="max-w-5xl mx-auto relative z-10">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
                {category.skills.map((skill, skillIndex) => (
                  <div
                    ...
                    style={{ animationDelay: `${(skillIndex + index * 4) * 0.05}s` }}
                  >
        ...
        <div className="mt-16 text-center animate-fade-in" style={{ animationDelay: "0.8s" }}>
          <Card className="bg-purple-800/10 border-purple-800/20 p-8">
            ...
            Habilidad para integrarme rápidamente a nuevos stacks,
            frameworks y procesos de desarrollo.
            </p>
          </Card>
        </div>
      </div>
