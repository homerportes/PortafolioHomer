...
const AboutSection = () => {
  ...
  const education = [
    {
      ...
      highlights: t("education.degree1.highlights").split(","),
    },
    {
      ...
      highlights: t("education.degree2.highlights").split(","),
    },
  ];
  ...
  return (
    <section id="about" className="py-20 md:py-32 px-6 md:px-16 relative">
